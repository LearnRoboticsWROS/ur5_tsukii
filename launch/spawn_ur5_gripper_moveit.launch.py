...
def generate_launch_description():
    ...
    # --- share dirs ---
    uryt_share     = get_package_share_directory("ur5_tsukii")
    ...
    #     get_package_share_directory('ur5_tsukii'), 'worlds', 'world1.world'
    # )
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={"use_sim_time":"true", "gui":"true", "paused":"true",
                           #'world' : world_file,
                           }.items()
    )
    ...
    # --- RViz (opzionale) ---
    rviz_cfg = os.path.join(get_package_share_directory("ur5_camera_moveit_config"),
                            "config", "moveit.rviz")
    rviz = Node(
